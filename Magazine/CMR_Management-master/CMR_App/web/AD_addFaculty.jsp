<%-- 
    Document   : AD_addFaculty
    Created on : Oct 24, 2016, 2:02:26 PM
    Author     : khatn
--%>
      ...
      <div class="row">
        <div class="col-md-8 col-xs-12 col-sm-12">
          ...
          <div class="box box-warning">
             <form role="form" action="admin?act=addFA" method="post">
            <div class="box-header with-border">
              <h3 class="box-title">Add New Faculty Form</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="opid">
                     <c:forEach items="${listAy}" var="n">
                         <option value="${n.getOp_ID()}">${n.getOp_year()}</option>
                     </c:forEach>
                  </select>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group date">
                    <div class="input-group-addon">
                      ...
                      <input type="text" class="form-control pull-right" id="datepicker" name="dateStart">
                  </div>
                  <!-- /.input group -->
                </div>
                 <!-- Date range -->
                <div class="form-group">
                  ...
                  <div class="input-group date">
                    <div class="input-group-addon">
                      ...
                      <input type="text" class="form-control pull-right" id="datepicker1" name="dateEnd">
                  </div>
                  <!-- /.input group -->
                </div>
                <!-- /.form group -->
                <div class="form-group">
                  <label>Select Marketing Coordinator</label>
