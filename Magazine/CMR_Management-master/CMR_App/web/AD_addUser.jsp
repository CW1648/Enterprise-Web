<%-- 
    Document   : AD_addUser
    Created on : Oct 24, 2016, 1:58:42 PM
    Author     : khatn
--%>
      ...
      <div class="row">
        <div class="col-md-8 col-xs-12 col-sm-12">
          ...
          <div class="box box-warning">
            ...
            <!-- /.box-header -->
            <div class="box-body">
                <form role="form" action="admin?act=addUser" method="post">
                <!-- text input -->
                ...
                <div class="form-group">
                  <label>Addess</label>
                  <input type="text" class="form-control" placeholder="Addess" accept="address">
                </div>
                <div class="form-group">
