<%-- 
    Document   : AD_addAY
    Created on : Oct 24, 2016, 2:02:49 PM
    Author     : khatn
--%>
...
<head>
  ...
  <title>FPT Greenwich | Administrator</title>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
          ...
          <li class="treeview">
              <a href="#">
                  <i class="fa fa-tasks"></i> <span>Academic Year</span>
                  <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
              </a>
              <ul class="treeview-menu">
          ...
          <li class="treeview">
              ...
              <ul class="treeview-menu">
                  <li><a href="#"><i class="fa fa-circle-o"></i> Statistical Reports</a></li>
                  <li><a href="#"><i class="fa fa-circle-o"></i> Exceptional Reports</a></li>
              </ul>
          </li>
      </ul>
    </section>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Add New Academic Year</li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-md-8 col-xs-12 col-sm-12">
          ...
          <div class="box box-warning">
              <form role="form" action="admin?act=addAY" method="post">
            <div class="box-header with-border">
              <h3 class="box-title">Add New Academic Year Form</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              ...
              <!-- Date range -->
                <div class="form-group">
                  ...
                  <div class="input-group date">
                    <div class="input-group-addon">
                      ...
                      <input type="text" class="form-control pull-right" id="datepicker" name="year">
                  </div>
                  <!-- /.input group -->
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="input-group date">
                    <div class="input-group-addon">
                      ...
                      <input type="text" class="form-control pull-right" id="datepicker1" name="dateStart">
                  </div>
                  <!-- /.input group -->
                </div>
                 <!-- Date range -->
                <div class="form-group">
                  ...
                  <div class="input-group date">
                    <div class="input-group-addon">
                      ...
                      <input type="text" class="form-control pull-right" id="datepicker2" name="dateEnd">
                  </div>
                  <!-- /.input group -->
                </div>
                <!-- /.form group -->
                <div class="form-group">
                  ...
                  <select class="form-control" name="mmid">
                    <c:forEach items="${listmm}" var="n">
                    
                        <option value="${n.getUserID()}">${n.getUserName()}</option>
