<%-- 
    Document   : Student_editCon
    Created on : Oct 19, 2016, 8:17:05 AM
    Author     : BUIVUHUECHI
--%>
  ...
  <div class="wrapper">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="Student_addNewCon.jsp"><i class="fa fa-circle-o"></i> Add New Contributions</a></li>
    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        <div class="row">
          <div class="col-md-3">
            <a href="Student_viewAllCon.html" class="btn btn-primary btn-block margin-bottom">Cancel</a>
          ...
          <div class="col-md-9">
            <div class="box box-primary">
              <div class="box-header with-border">
                <h3 class="box-title">Edit Contribution</h3>
              </div>
              <!-- /.box-header -->
               <form action="ShowArticles?act=update&id=${editID}"  method="post" enctype="multipart/form-data">
              <div class="box-body">
              ...
              <div class="box-footer">
                <div class="pull-right">
                  <button type="submit" class="btn btn-primary"><i class="fa fa-envelope-o"></i> Edit</button>
                </div>
